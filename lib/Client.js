...
var Channel = require("./channel.js"),
    ...
    VoiceChannelConnection = require("./VoiceChannelConnection.js");
  ...
  */
     ...
     */
					...
					if (userID === self.user.id) {
						if (self.voiceChannels[data.channel_id]) self.voiceChannels[data.channel_id].sessionID = data.session_id;
					}
